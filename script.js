document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getFieldError(field) {
      ...
      if (field.tagName === 'TEXTAREA' && field.hasAttribute('minlength')) {
        ...
        if (value.length < min) {
          return (field.dataset.errorMinlength || 'Please enter at least {min} characters.').replace('{min}', min);
        }
      }
      ...
      if (field.hasAttribute('minlength') && value !== '') {
        const min = parseInt(field.getAttribute('minlength'), 10);
        if (value.length < min) {
          return (field.dataset.errorMinlength || 'Minimum {min} characters required.').replace('{min}', min);
        }
      }
  ...
  const OBSERVE_SELECTORS = '.fade-in, .animate-on-scroll, [data-animate]';
  const animatableEls     = document.querySelectorAll(OBSERVE_SELECTORS);
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ALONA PHOTO משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '894d2b81-1839-4837-9493-ebc77ed9ccb1',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '894d2b81-1839-4837-9493-ebc77ed9ccb1';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '894d2b81-1839-4837-9493-ebc77ed9ccb1';
